...
Puede probar la aplicación en Windows descargando [CsvDbQ para Windows](https://assets.facite.es/csvdbq/download/CsvDbQ-0.1.3_win_x64.zip) que incluye un jre-21 integrado y el ejecutable de la aplicación (generado con launch4j y Java jdeps/jlink)
